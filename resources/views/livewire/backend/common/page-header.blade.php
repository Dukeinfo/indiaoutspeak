<div class="navbar-header">
	...
	<div class="d-flex">
		...
		<div class="dropdown d-inline-block">
			...
			data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				<img class="rounded-circle header-profile-user" src="{{isset(Auth::user()->profile_photo_path) ?  get_user_profile(Auth::user()->profile_photo_path) :asset('admin_assets/images/users/avatar-1.jpg')}}"
					alt="Header Avatar">
