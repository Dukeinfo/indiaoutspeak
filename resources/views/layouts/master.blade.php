...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ isset($siteSetting->apple_touch_icon) ? getSiteLogos($siteSetting->apple_touch_icon) :  asset('/public/assets/images/icons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ isset($siteSetting->apple_touch_icon) ? getSiteLogos($siteSetting->apple_touch_icon) :  asset('/public/assets/images/icons/apple-touch-icon.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/public/assets/css/util.min.css')}}">
